...
RelaxedTaskGraph::RelaxedTaskGraph(const TaskProxy &task_proxy)
    ...
    */
    ...
    /*
      TODO: add your code for part (c) here. After construction
        ...
        - graph should contain precondition and effect nodes for all operators
        - graph should contain all necessary edges.
    */
}
...
int RelaxedTaskGraph::ff_cost_of_goal() {
    ...
    // TODO: add your code for part (d) here.
    return -1;
}
